...
const FacebookProductPage = () => {
  ...
  return (
    // 2. استخدام الغلاف بدلاً من div عادي
    // dir مهم لضبط اتجاه اللغة
      ...
      <main className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-sm text-gray-400 mb-6">
            <Link href="/" className="hover:underline">Home</Link> / <span className="text-white font-medium">Product</span> / Facebook
          </div>
          ...
          <div className="mt-16 text-center">
            <Link 
              href="/signup" 
              className="inline-block px-8 py-4 bg-blue-600 text-white rounded-full font-bold text-lg hover:bg-blue-700 hover:scale-105 transition-all duration-200 shadow-xl shadow-blue-500/20 z-20 relative"
            >
              {t.cta}
            </Link>
          </div>
