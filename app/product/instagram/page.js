      ...
      <main className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-sm text-gray-500 mb-6">
            <Link href="/" className="hover:underline">Home</Link> / <span className="text-black dark:text-white font-medium">Product</span> / Instagram
          </div>
          ...
          <div className="mt-16 text-center">
            <Link 
              href="/signup" 
              className="inline-block px-8 py-4 bg-black dark:bg-white text-white dark:text-black rounded-full font-bold text-lg hover:scale-105 transition-transform duration-200 shadow-xl"
            >
              {t.cta}
            </Link>
          </div>
